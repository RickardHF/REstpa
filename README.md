...
This repository host two workshops for getting more familiar with concepts in agentic worksflow and customization.
...
In thgis repository we aim to have an application residing in the src folder. Here you can find a description of it and functional requirements. 
